    ...
    return (
        <Container>
            <ImageContainer>
                ...
                {props.thaiChef[0] &&
                    <Card>
                        <ImageCardStyle image={props.thaiChef[0].chefImage} title="Indian Dish" />
                        <ColumnTitle> {props.thaiChef[0].chefName} – {props.thaiChef[0].chefDesignation} </ColumnTitle>
                        <MediumFonts>{props.thaiChef[0].chefContent} </MediumFonts>
                    </Card>
                }
            </ImageContainer>
        </Container>
